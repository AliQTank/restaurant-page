export const doradoInfo = {
        ...
        recomienda optar por una cocción a la parrilla, a la plancha o al vapor. Mientras que el horneado se debe evitar al correr
        el riesgo de que la carne pueda quedar seca y dura.`,
...
export const robaloInfo = {
        ...
        de cultivo ya que se puede desarrollar en agua dulce, salobre y marina, lo que representa un área de oportunidad para la
...
export const cazonInfo = {
        ...
        saborYTexstura : `El cazon es conocido por su sabor suave, delicado y con un ligero toque a mar. Además, su carne es firme
         ...
         organismo altas concentraciones de mercurio. Este metal pesado puede ser tóxico para los seres humanos y causar problemas
         neurológicos, del desarrollo y otros efectos adversos.`,
         desventajas2 : `Sobrepesca y riesgos de extinción: El cazón es un pez que ha sido sobrepescado en muchos lugares del mundo,
         lo que ha llevado a una reducción significativa de sus poblaciones. Esto puede afectar la biodiversidad marina y tener
         impactos negativos en las comunidades que dependen del pescado como fuente de alimentación o ingresos.`,
...
export const lenguadoInfo = {
        ...
        su carne es muy frágil y es fácil que se desmigue.
