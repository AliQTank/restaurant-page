...
export const chicharronDePescado = {
...
export const chocolataEnSalsasNegras = {
...
export const chocolataAlMojoDeAjo = {
    modoDePreparacion : `se ponen a cocer previamente las almejas, y solamente las que se abran despues de cocer
...
export const calamarAlMojoDeAjo = {
...
export const cevicheDeCalloDeAlmeja = {
...
export const salmonAlMojoDeAjo = {
...
export const ensaladaDeSurimi = {
    modoDePreparacion : `se raya zanahoria y pepinoy se mezcla con crema y mayonesa. se puede agregar tambien cebolla fina y chile. S
    se agrega sal, pimienta`
}

export const fileteDeDoradoConSalsaDeMango = {
    modoDePreparacion : `En una sartén caliente, cocina los filetes de dorado a la plancha hasta que estén dorados por ambos lados.
...
export const doradoAlHornoConLimonYHierbas = {
    modoDePreparacion : `Prepara los filetes de dorado en una bandeja para horno, exprime limón sobre ellos, añade las hierbas
